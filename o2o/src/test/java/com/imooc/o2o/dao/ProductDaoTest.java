...
public class ProductDaoTest extends BaseTest {
	...
	@Test
	public void testBQueryProductListAndCount() throws Exception{
	...
	public void testCQueryProductByProductId() throws Exception{
		long productId = 1L;
		//初始化两个商品详情图实例作为prouct为1的商品下的详情图片
		//批量插入到商品详情图列表中
...
//		assertEquals(2, effectedNum);
		//查询productId为1的商品信息，并校验返回的详情图片实例列表size是否为2
...
//		assertEquals(2, effectedNum);
	...
	public void testEUpdateProductCategoryToNull(){
		//将productCategoryId为2的商品类别下面的商品类别置空
