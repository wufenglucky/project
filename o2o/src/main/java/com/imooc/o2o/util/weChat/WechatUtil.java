...
public class WechatUtil {
	...
	public static UserAccessToken getUserAccessToken(String code) throws IOException{
		//测试号信息里的appId
		String appId = "wx7ad1b3ebc79f25b3";
		log.debug("appId:" + appId);
		//测试号信息里的appsecret
		String appsecret = "e575f9c024ad2522d8bcd920f7f7c455";
		log.debug("secret:" + appsecret);
		//根据传入的code拼接出访问微信定义好的接口的URL
		String url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=" + appId +"&secret=" + appsecret
				+ "&code=" + code + "&grant_type=authorization_code";
		//响应URL发送请求，获取token json字符串
	...
	public static WechatUser getUserInfo(String accessToken, String openId){
		//根据传入的accessToken以及openId拼接出访问微信定义的端口，并获取用户信息的URL
	...
	/**
	 * 发起https请求，并获取结果(利用"SSL"协议对http请求进行加密，形成https)
	 * @param requestUrl
	 * 		请求的地址
	 * @param requestMrthod
	 * 		请求方式(GET、POST)
