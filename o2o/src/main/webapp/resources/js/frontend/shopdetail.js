$(function() {
	...
	function addItems(pageSize, pageIndex){
		//拼接出查询的URL，赋空值就去掉这个条件限制，有值就代表按照这个条件去查询
	...
	$('#shopdetail-button-div').on('click', 'button', function(e){
		...
		if(productCategoryId){
			//如果之前已选定了别的category，则移除选定效果，改成选定新的
	...
	//需要查询的商品名字发生变化后，重置页码，清空原先商品列表，按照新的名字查询显示
